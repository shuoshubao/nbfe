...
(function (global, factory) {
    ...
    var memoize = function memoize(fn) {
        ...
        var memoized = function memoized() {
            ...
            var data = fn.apply(void 0, _toConsumableArray(newArgs));
            caches.unshift({
                args: newArgs,
                data: data
            });
    ...
    var sleep = function sleep() {
        ...
        var sleepTime = time < 0 ? _.random(2, 5) : time; // eslint-disable-next-line no-promise-executor-return
    ...
    var gernerateElementText = function gernerateElementText() {
        ...
        var attrsText = Object.entries(attrs)
            .map(function (_ref) {
                var _ref2 = _slicedToArray(_ref, 2),
                    k = _ref2[0],
                    v = _ref2[1];
    ...
    var getImageSize = function getImageSize() {
        ...
        return new Promise(function (reslove) {
            ...
            img.onerror = /*#__PURE__*/ _asyncToGenerator(
